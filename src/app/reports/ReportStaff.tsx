...
import { getReportStaff } from "../../../api/staffreport.api";
      ...
      return (
        <div>
          ...
          <div className="my-2 mx-2">
            <button className="bg-blue-700 text-white py-2 px-4 rounded" onClick={() => exportToExcel(staff)}>Xuat file excel</button>
          </div>
        </div>
      );
}